  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { key: 'recruit-auto', label: '自动沟通', path: '/customer/recruitment/auto' },
        { key: 'recruit-post', label: '发布职位', path: '/recruitment/publish' },
        { key: 'recruit-screen', label: '简历筛选', path: '/recruitment/screen' },
        { key: 'recruit-interview', label: '面试管理', path: '/recruitment/interview' },
