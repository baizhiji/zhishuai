  ...
  const columns = [
    ...
    },
    {
      ...
      render: (platform: string) => {
        ...
        return (
          <Tag style={{ backgroundColor: config.color, color: '#fff', border: 'none' }}>
            {config.label}
          </Tag>
        );
      },
              ...
              {platformData.map((item, index) => (
                <div key={index}>
                  ...
                  >
                    ...
                    <Text type="secondary">
                      {item.views.toLocaleString()} ({item.rate}%)
                    </Text>
                  </div>
                  <Progress
                    percent={item.rate}
