...
=======
                <span style={{ fontSize: 14, color: '#52c41a' }}>+{stats.todayScans} 今日</span>
>>>>>>> 962968886be726cd434c792933b5515366d34518
              }
...
=======
              suffix={<span style={{ fontSize: 14, color: '#722ed1' }}>+{stats.newUsers} 新</span>}
>>>>>>> 962968886be726cd434c792933b5515366d34518
...
=======
            ...
            { title: '占比', dataIndex: 'rate', key: 'rate', render: (rate: number) => `${rate}%` },
            {
              ...
              render: (_: any, record: any) =>
                `${((record.users / record.scans) * 100).toFixed(1)}%`,
>>>>>>> 962968886be726cd434c792933b5515366d34518
            },
            {
              title: '操作',
