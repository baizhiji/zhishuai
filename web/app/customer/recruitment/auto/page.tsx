  ...
  const [logs] = useState<ConversationLog[]>([
    {
      ...
      sender: 'HR小王',
      receiver: '李明',
      originalMessage: '您好，我想咨询一下这个岗位的薪资范围',
      generatedReply: '您好，我们岗位薪资范围是15-25K，具体根据您的工作经验...',
      template: '收到简历自动回复',
      scenario: 'recruitment',
      style: 'friendly',
      feedback: 'good',
    ...
    },
    {
      ...
      sender: 'HR小李',
      receiver: '王芳',
      originalMessage: '请问贵公司加班多吗？',
      generatedReply: '您好，我们公司实行弹性工作制，不强制加班...',
      template: '收到简历自动回复',
      scenario: 'recruitment',
      style: 'friendly',
      feedback: 'good',
    ...
    },
    {
      ...
      sender: 'HR小张',
      receiver: '赵六',
      originalMessage: '可以远程面试吗？',
      generatedReply: '您好！当然可以，我们支持线上面试，请问您方便什么时间呢？',
      template: '面试邀请',
      scenario: 'recruitment',
      style: 'friendly',
      feedback: null,
    ...
    },
    {
      ...
      sender: '运营小明',
      receiver: '粉丝A',
      originalMessage: '这个产品好用吗？',
      generatedReply: '感谢您的关注！这款产品我们卖得特别好，用户反馈很不错呢~',
      template: '感谢关注回复',
      scenario: 'social_media',
      style: 'casual',
      feedback: 'good',
                        ...
                        actions={[
                          <Tooltip title="好评">
                            <Button
                              type="text"
                              icon={<LikeOutlined />}
                              style={{ color: item.feedback === 'good' ? '#52c41a' : undefined }}
                            />
                          </Tooltip>,
                          <Tooltip title="差评">
                            <Button
                              ...
                              style={{ color: item.feedback === 'bad' ? '#ff4d4f' : undefined }}
                            />
                          </Tooltip>,
                        ]}
                      >
                  ...
                  {Object.entries(STYLE_CONFIG).map(([key, config]) => (
                    <Col span={12} key={key}>
                      ...
                      >
                        ...
                        <Tag color="blue">
                          {templates.filter(t => t.style === key).length} 个话术
                        </Tag>
                      </Card>
                    </Col>
                  ))}
      ...
      >
        <Form form={aiForm} layout="vertical">
          ...
          <Form.Item
            name="context"
            label="话术主题/场景描述"
            rules={[{ required: true, message: '请描述话术主题' }]}
          >
            <TextArea
              rows={3}
