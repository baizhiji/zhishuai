...
// 模拟已绑定的账号
const mockBoundAccounts: BoundAccount[] = [
  { platform: 'boss', accountName: '智枢科技-HR', boundAt: '2025-05-15', status: 'active' },
  { platform: 'zhilian', accountName: 'hr@zhishuai.com', boundAt: '2025-05-10', status: 'active' },
];
...
export default function RecruitmentPlatforms() {
  ...
  const [boundAccounts, setBoundAccounts] = useState<BoundAccount[]>(mockBoundAccounts);
    ...
    <div style={{ padding: '24px' }}>
      ...
      <Card title="授权说明" style={{ marginTop: 24 }}>
        <Row gutter={24}>
          ...
          <Col span={8}>
            <Title level={5}><EnvironmentOutlined /> 自动沟通候选人</Title>
            <Text type="secondary">
