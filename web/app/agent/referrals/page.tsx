  ...
  const recordData = [
    {
      ...
      referred: '李四',
      status: '成功',
      registerTime: '2024-03-25 15:00',
    },
    {
      key: '2',
      referrer: '张三',
      time: '2024-03-24 11:20',
      referred: '王五',
      status: '成功',
      registerTime: '2024-03-24 12:00',
    },
    {
      key: '3',
      referrer: '李四',
    ...
    },
    {
      key: '4',
      referrer: '王五',
      time: '2024-03-22 16:45',
      referred: '钱七',
      status: '成功',
      registerTime: '2024-03-22 17:30',
    },
    {
      key: '5',
      referrer: '李四',
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Card bordered={false} title="推荐记录">
        <Table dataSource={recordData} columns={recordColumns} pagination={{ pageSize: 10 }} />
      </Card>
    </div>
  );
}
