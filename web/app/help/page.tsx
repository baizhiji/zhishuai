...
const mockFAQs: FAQ[] = [
  ...
  { id: 4, category: 'payment', question: '支持哪些支付方式？', answer: '我们支持微信支付、支付宝、银联卡等多种支付方式。', views: 987 },
  { id: 5, category: 'feature', question: '如何使用矩阵管理功能？', answer: '在矩阵管理页面，点击"添加账号"，通过扫码授权绑定您的社交媒体账号，即可统一管理。', views: 3456 },
  { id: 6, category: 'feature', question: 'AI 对话引擎如何使用？', answer: '进入 AI 对话页面，选择合适的 AI 模型，输入您的问题即可获得智能回答。', views: 2876 },
  { id: 7, category: 'feature', question: '招聘助手的简历筛选准吗？', answer: '我们的 AI 简历筛选基于多维度分析，包括技能匹配度、工作经验、教育背景等，准确率可达 85% 以上。', views: 1567 },
  { id: 8, category: 'technical', question: 'API 调用失败怎么解决？', answer: '请检查：1. API Key 是否正确配置；2. 调用频率是否超限；3. 网络连接是否正常。', views: 2345 },
  { id: 9, category: 'technical', question: '数据导出支持哪些格式？', answer: '支持 Excel、CSV、JSON 三种格式导出，您可以在数据报表页面选择导出格式。', views: 1234 },
  { id: 10, category: 'technical', question: '系统运行缓慢怎么办？', answer: '建议：1. 清理浏览器缓存；2. 使用 Chrome 或 Firefox 最新版本；3. 检查网络速度。', views: 987 },
];

const helpArticles: HelpArticle[] = [
  { id: 1, title: '快速入门指南', category: 'getting-started', description: '5分钟快速上手智枢 AI', icon: <BookOutlined style={{ fontSize: 32, color: '#1890ff' }} /> },
