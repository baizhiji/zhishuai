...
export const CONTENT_TYPES = [
  { id: 'title', name: '标题', icon: 'text-outline', color: '#6D28D9', description: '生成吸引人的标题', tags: ['吸引点击', 'SEO优化', '热点标题'] },
  ...
  { id: 'ecommerce', name: '电商详情页', icon: 'bag-outline', color: '#7C3AED', description: '生成电商详情页', tags: ['产品详情', '卖点提炼', '买家秀'] },
  { id: 'video', name: '短视频', icon: 'videocam-outline', color: '#DC2626', description: '生成短视频脚本', tags: ['口播脚本', '分镜脚本', '剧情脚本'] },
  { id: 'digitalHuman', name: '数字人短视频', icon: 'people-outline', color: '#6D28D9', description: '生成数字人视频脚本', tags: ['数字人', 'AI主播', '虚拟形象'] },
];
